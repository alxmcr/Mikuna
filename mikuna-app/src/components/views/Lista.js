        ...
        <Paper style={style.paper}>
          <Grid item xs={12} sm={12}>
            <Breadcrumbs aria-label="breadcrumbs">
              ...
              <Typography color="textPrimary">Mis Proveedores</Typography>
            </Breadcrumbs>
          </Grid>
          <Grid item xs={12} sm={6} style={style.gridTextfield}>
            <TextField
              ...
              name="textoBusqueda"
              variant="outlined"
              label="Ingrese proveedores a buscar"
              ...
              {this.state.inmuebles.map(card => (
                <Grid item key={card.id} xs={12} sm={6} md={4}>
                  <Card style={style.card}>
                    ...
                    <CardActions>
                      <Button size="small" color="primary" onClick={() => this.editarItem(card.id)}>
                        Editar
                      </Button>
...
export default consumerFirebase(Lista);
